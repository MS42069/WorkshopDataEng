...
@Schema(
        description =
                "DTO that is sent as request to the server to create a new course distribution constraint or to"
                        + " modify the properties of an existing constraint")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Builder
public class CourseDistributionConstraintReqDTO {
